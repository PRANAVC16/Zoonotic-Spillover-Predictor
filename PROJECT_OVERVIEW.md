...
### Objective. 
To investigate whether routinely obtainable climate, satellite and landscape indicators can provide useful predictive signal for reported KFD outbreak occurrence, while building a reproducible and interpretable geospatial machine-learning framework that can later be extended to other zoonotic diseases.
